...
db.bookmarks = new Datastore({
	filename: path.join(data_path, 'db/bookmarks.db'),
	autoload: true
});
db.settings = new Datastore({
	filename: path.join(data_path, 'db/settings.db'),
	autoload: true
});
db.tvshows = new Datastore({
	filename: path.join(data_path, 'db/shows.db'),
	autoload: true
});
db.movies = new Datastore({
	filename: path.join(data_path, 'db/movies.db'),
	autoload: true
});
db.watched = new Datastore({
	filename: path.join(data_path, 'db/watched.db'),
	autoload: true
});
